...
const ShapeFive = ({ setComponent,remove = false, removeComponent,index }: any) => {
    return (
        <div className='section-structure structure-four flex justify-between items-center py-3 pl-4 relative' onClick={setComponent}>
