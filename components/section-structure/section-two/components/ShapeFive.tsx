...
const ShapeFive = ({ remove = false, removeComponent, id, draggable = true }: any) => {

    const { setComponent } = useContext(DragContext);
    
    return (
        <div className='section-structure structure-four flex justify-between items-center py-3 pl-4 relative'
            draggable={draggable}
            onDragStart={() => setComponent('five')}
        >
